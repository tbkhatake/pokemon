...
<section class="services">
    <div class="services__digital">
        ...
        <?php if(have_rows('services_icone')): ?>
            <div class="services-slider-controls" id="<?=$key?>" aria-label="Carousel Navigation" tabindex="0">
                <img class="services-controls-btn" src="<?=get_template_directory_uri()?>/images/servicos-digitais/left-arrow.svg" alt="left-arrow">
                <img class="services-controls-btn" src="<?=get_template_directory_uri()?>/images/servicos-digitais/right-arrow.svg" alt="right-arrow">
            </div>
    ...
    <?php endif; ?>
    <?php get_template_part("template-parts/servicos-digitais/plans");?>
    ...
    <section class="step-sd">
        ...
        <div class="steps-mainly-wrapper">
                    ...
                    <div class="steps-wrapper">
                        <div class="steps-slider">
                            ...
                            <div class="step-slider-controls-wrapper">
                                <div class="step-slider-controls" id="<?=$key+1?>" aria-label="Carousel Navigation" tabindex="0">
