        ...
        <img class="modal__logo" src="<?= get_template_directory_uri() ?>/images/logo.svg" alt="">
            <div class="modal__cities-box">
                ...
                <div class="modal__cities">
                  <?php if ($city_plans_query->have_posts()):
                  	while ($city_plans_query->have_posts()):
                  		$city_plans_query->the_post(); ?>
      ...
      <div class="forms-container">
          <form class="forms-wrapper" action="">
              <p class="forms-desc">Por gentileza, nos envie a sua cidade.</p>
                ...
                <div class="fields-wrapper">
                    <input class="tiny-form" id="forms-input-tel" type="text" name="Telefone" required placeholder="Telefone">
                    <p class="required-tel">Digite um telefone válido*</p>
                </div>
                <div class="fields-wrapper">
                    <input class="tiny-form" id="forms-input-email" type="email" name="Email" required placeholder="Email">
                    <p class="required-email">Digite um e-mail válido*</p>
                </div>
                <div class="fields-wrapper">
                    <div class="fields-wrapper-state">
                        <input class="tiny-form tiny-form-city" id="forms-input-city" name="Cidade" type="text" required placeholder="Cidade">
                        <input class="tiny-form tiny-form-state" id="forms-input-state" name="Estado" type="text" required placeholder="Estado">
                    </div>
                    <p class="required-address">Preenchimento obrigatório*</p>
                </div>
                <div class="form-button-wrapper">
                    <input class="forms-button" type="submit" value="Enviar">
                    <span class="button-validation">Enviar</span>
                </div>
          </form>
      </div>
    </div> -->
